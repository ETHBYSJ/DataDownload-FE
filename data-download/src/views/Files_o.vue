<template>
  <div class="wrapper">
    ...
    <div class="button-group">
      ...
      <el-button type="primary" icon="el-icon-upload" @click="handleUploadDir">{{$t('m.Upload')}}</el-button>
    ...
    <!-- 上传对话框 -->
    <el-dialog :visible="uploadVisible" title="请上传文件夹" class="uploadDialog" width="500px" :before-close="handleUploadDialogClose">
      <div class="uploadDialogBody">
        <span><el-input v-model="dataPackName" placeholder="请输入数据包名称" clearable minlength=4 maxlength=20 show-word-limit class="uploadDialogInput"></el-input></span>
        <span><el-button class="uploadDialogDirSelect">选择文件夹</el-button></span>    
      </div>
      <div>
        <p>您选择的文件夹图片数量为{{}}</p>
        <p>您选择的文件夹含有数据包简介</p>
